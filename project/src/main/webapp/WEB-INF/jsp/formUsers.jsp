								...
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td>
											<a href="editUsers?id=${users.id}"><span class="glyphicon glyphicon-pencil"></span></a>
											&nbsp;
											<a href="users/${users.id}/delete" onclick="return confirm('Bạn chắc chắn muốn xóa ?')"><span class="glyphicon glyphicon-trash"></span></a>
											</td>
