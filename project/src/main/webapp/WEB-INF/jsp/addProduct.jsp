...
<!-- Tell the brow	ser to be responsive to screen width -->
<meta
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<c:if test="${command != null}">
				<c:choose>
					<c:when test="${command.equalsIgnoreCase('add')}">
					...
					<c:when test="${command.equalsIgnoreCase('update')}">
						<form:form action="product/saveChange" modelAttribute="productForm" method="post">
							<table>
								<tr>
									<td>Danh Mục :</td>
									<td>
