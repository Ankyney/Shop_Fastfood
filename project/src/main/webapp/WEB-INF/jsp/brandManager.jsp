								...
								<table id="example1" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th width="200px">Tên Thương hiệu</th>											
											<th width="500px">Chi tiết</th>
											<th width="15px">Thao tác</th>
										</tr>
									</thead>
									<tbody>
										...
										<tr>
											...
											<td>
											<a href="editBrand?id=${brand.id}"><span class="glyphicon glyphicon-pencil"></span></a>
											&nbsp;
											<a href="brand/${brand.id}/delete" onclick="return confirm('Bạn chắc chắn muốn xóa ?')"><span class="glyphicon glyphicon-trash"></span></a>
											</td>
