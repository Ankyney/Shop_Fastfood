						...
						<form class="form-horizontal" action="saveChangeBrand" method="post">
							<fieldset>
								<div class="form-group">
									<div class="col-md-5">
										<input type="text" class="hidden form-control id" name="id" value="${brand.id}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" class="form-control name" name="name" value="${brand.name}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<textarea rows="15" class="form-control des" name="description">${brand.description}</textarea>
									</div>
								</div>
