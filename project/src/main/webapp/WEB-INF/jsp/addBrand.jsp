...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<!-- Main content -->
			<form action="brandManager/save" method="POST">
				<table>
					<tr>
						<th style="width: 150px; text-align: center;">STT</th>
						<th style="width: 150px; text-align: center;">Tên Thương hiệu</th>
					...
					<tr>
						<td>
							<div class="form-group required has-feedback">
								...
								<input name="name" data-error="Must be a valid name" id="name" class="form-control">
							</div>
						</td>
						<td>
							<div class="form-group required has-feedback">
								<label for="description" class="control-label">Chi Tiết</label>
								<input name="description" data-error="Must be a valid description" id="description" class="form-control">
							</div>
						</td>
					</tr>
					<tr>
						<td>
							<input type="submit" value="Lưu dữu liệu" />
							<input type="button" value="Quay lại" onclick="window.location.back()"/>
						</td>
					</tr>
				</table>
			</form>
